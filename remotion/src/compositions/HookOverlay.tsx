...
const HOOK_LOOKS: Record<string, HookLook> = {
  classic: { box: "rgba(18,18,20,0.94)", text: "#FFFFFF", outlinePx: 0, outlineColor: "#000", shadow: true },
  black_white: { box: "rgba(18,18,20,0.94)", text: "#FFFFFF", outlinePx: 0, outlineColor: "#000", shadow: true },
  dark: { box: "rgba(18,18,20,0.92)", text: "#FFFFFF", outlinePx: 0, outlineColor: "#000", shadow: true },
  white_card: { box: "rgba(255,255,255,0.94)", text: "#000000", outlinePx: 0, outlineColor: "#000", shadow: true },
