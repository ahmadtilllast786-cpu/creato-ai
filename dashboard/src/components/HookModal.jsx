...
const HOOK_STYLES = [
    { value: 'classic', label: 'Black & White (Default)', box: 'rgba(18,18,20,0.94)', text: '#fff' },
    { value: 'dark', label: 'Dark', box: 'rgba(18,18,20,0.92)', text: '#fff' },
    { value: 'white_card', label: 'White Card', box: 'rgba(255,255,255,0.94)', text: '#000' },
                        ...
                        <>
                            ...
                            <div className={`absolute w-full px-8 text-center transition-all duration-300 pointer-events-none flex flex-col h-full ${getPositionClass()}`}>
                                <div
                                    ...
                                    style={{
                                        ...getSizeStyle(),
                                        backgroundColor: HOOK_STYLES.find(s => s.value === style)?.box || 'rgba(18, 18, 20, 0.94)',
                                        color: HOOK_STYLES.find(s => s.value === style)?.text || '#ffffff',
