...
# --- Free Edge-TTS Dubbing / Speech Alternative ---
EDGE_VOICES = {
...
def generate_edge_tts(text: str, language: str = "en", output_path: str = "voice.mp3") -> str:
    """Generate high-quality voiceover for 100% free using Microsoft Edge-TTS."""
    import asyncio
    import edge_tts

    voice = EDGE_VOICES.get(language, "en-US-ChristopherNeural")
